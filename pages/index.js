    ...
    <>
      ...
      <div className='mt-4 p-4'>
        ...
        <div className='mt-4'>
          ...
          <div className="card custom-card-bg max-w-third p-2 mt-2">
            <p className='white'>{`<link rel="stylesheet" href="https://broken-lazy.vercel.app/css/index.css" />`}</p>
          </div>
        </div>
        <div className='mt-4'>
        ...
        <div className='mt-4'>
          ...
          <Link href="/responsive" passhref><button className='custom-btn-rounded white mt-2'>Learn More</button></Link>
        </div>
      </div>
