        ...
        <>
            <form>
                <div className="display-f-col mt-2">
                    <label htmlFor="test-1" className="form-label">Your name</label>
                    <input type="text" id="test-1" className="mt-1 input-t" />
                </div>
                <div className="display-f-col mt-2">
                    <label htmlFor="test-2" className="form-label">Age?</label>
                    <input type="text" id="test-2" className="mt-1 input-t"  placeholder="placeholder" />
                </div>
                <div className="display-f-col mt-2">
                    <label htmlFor="test-3" className="form-label">From?</label>
